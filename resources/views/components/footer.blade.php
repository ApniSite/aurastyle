<footer class="bg-gray-50 sm:px-2 lg:px-4 border-b border-gray-900">
    <div class="max-w-screen-xl flex flex-wrap mx-auto py-6">
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
            <h4 class="my-4 text-2xl font-bold">Customer</h4>
        ...
        <div class="w-full px-4 lg:w-4/12">
            <h4 class="my-4 text-2xl font-bold">Download App</h4>
    ...
    <div class="items-centers grid grid-cols-1 justify-between gap-4 md:grid-cols-2 border-t border-gray-200 p-4">
        <p class="text-sm text-gray-500 max-sm:text-center">
            &copy; {{ now()->year }} | <a href="{{ config('app.url') }}" class="font-bold">{{ config('app.name') }}</a> | All Rights Reserved
        </p>
