<section  {{ $attributes }}>
  <div class="max-w-screen-xl mx-auto grid grid-cols-2 sm:grid-cols-9 gap-2 md:gap-2.5 mx-auto text-white">
    ...
    <span>
        <img alt="Women dress sale" src="{{ asset('images/banner-women-sale.webp') }}" alt="" class="transition-transform duration-300 group-hover:scale-105">
    </span>
    </a>
    <a href="{{ route('register') }}" class="group hidden sm:flex overflow-hidden col-span-1 sm:col-span-2 text-center flex bg-teal-500 bg-opacity-60">
    <div>
    ...
    <a href="{{ route('register') }}" class="group hidden sm:flex overflow-hidden col-span-1 sm:col-span-2 text-center">
    <span>
    ...
    <!-- Row 2: Boxes -->
    <a href="{{ route('collection.view', ['slug' => 'kids']) }}" class="group hidden sm:flex overflow-hidden col-span-1 sm:col-span-2 text-center">
    <span class="relative">
    ...
    <a href="{{ route('collection.view', ['slug' => 'men']) }}" class="group hidden sm:flex overflow-hidden col-span-1 sm:col-span-2 text-center">
    <span>
    ...
    <a href="{{ route('collection.view', ['slug' => 'kids']) }}" class="flex group overflow-hidden col-span-2 sm:col-span-5 text-center">
    <div
    {{-- class="m-auto py-2" --}}
    >
    {{-- <h1 class="text-black text-3xl font-extrabold sm:text-5xl">
        ...
        <img alt="2025 Kids Collection" src="{{ asset('images/banner-kids-collection-2025.webp') }}">
    </div>
    </a>
  </div>
</section>