                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ($this->shippingOptions as $option)
                        <div>
                            ...
                            <label class="flex items-center justify-between p-4 text-sm font-medium border border-gray-200 rounded-lg shadow-sm cursor-pointer peer-checked:border-blue-500 hover:bg-gray-50 peer-checked:ring-1 peer-checked:ring-blue-500"
