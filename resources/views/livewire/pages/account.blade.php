<div class="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 lg:px-8 dark:bg-gray-800 text-gray-700 dark:text-gray-300">
    <div class="flex flex-col md:flex-row py-4">
        <nav class="basis-1/5 space-y-4 text-sm font-medium ml-4">
            <a href="#" class="block underline hover:opacity-75">Orders</a>
            <a href="{{ route('profile') }}" class="block underline hover:opacity-75">Profile</a>
        ...
        <div class="ml-4 mb-3 md:basis-4/5">
            ...
            <div class="w-full flex flex-col">
                ...
                <div class="flex flex-col items-center gap-8">
                    ...
                    <x-button.primary><a href="/">Continue shopping</a></x-button.primary>
                </div>
                @endif
            </div>
